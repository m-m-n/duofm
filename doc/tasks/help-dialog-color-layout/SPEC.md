...
- FR1.1: Display color cube (16-231) with 2 colors per line
- FR1.2: Display grayscale (232-255) with 2 colors per line
...
- `renderColorCube()`: Change from 6 colors per row to 2 colors per row
- `renderGrayscale()`: Change from 6 colors per row to 2 colors per row

## Test Scenarios

- [ ] Color cube displays 2 colors per line
- [ ] Grayscale displays 2 colors per line
- [ ] Dialog does not stretch horizontally
- [ ] Existing tests pass

## Success Criteria

- [ ] Color cube section shows 2 colors per line (108 lines total for 216 colors)
- [ ] Grayscale section shows 2 colors per line (12 lines total for 24 colors)
